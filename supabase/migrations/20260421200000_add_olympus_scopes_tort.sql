...
insert into public.olympus_device_failure_timeline (event_date, event, significance, is_future) values
  ...
  ('Mar 2026', 'MTMP Spring 2026 (New Orleans) features Olympus scopes breakout session — Burnett Law Firm & Hurwitz Law presenting',                        'Mass-tort community formally recognises Olympus scopes as an emerging tort',                       false),
...
insert into public.ad_observations_raw (
  ...
  ('meta_ad_library', '743815835366224',
   ...
   'image_video', 'https://olyscopes.legalcaseadvisor.org/olympus-infection-lawsuit',
  ...
  ('meta_ad_library', '818786827261683',
   ...
   'image_video', 'https://trk.indrn.com/69a846e4d63b91928256c2ba',
  ...
  ('meta_ad_library', '25969561039337733',
   ...
   'image_video', 'https://facebook.com/61582907223292',
  ...
  ('meta_ad_library', '2181554725915134',
   ...
   'image_video', 'https://olyscopes.legalcaseadvisor.org/olympus-quiz',
