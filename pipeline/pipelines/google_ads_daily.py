...
def _log_searchapi_call(engine: str, query: str) -> None:
    ...
    log_api_call(
        ...
        called_from="pipelines.google_ads_daily",
...
TORT_SEARCH_TERMS: dict[str, list[str]] = {
    ...
    "bair_hugger":           ["bair hugger lawsuit", "bair hugger lawyer", "bair hugger infection lawyer", "forced air warming lawsuit", "3M bair hugger lawsuit"],
    ...
    "olympus_scopes":         ["Olympus duodenoscope lawsuit", "Olympus scope infection lawyer", "Olympus bronchoscope lawsuit", "duodenoscope infection lawsuit"],
    "ai_suicide":             ["AI chatbot lawsuit", "Character.AI lawsuit attorney", "AI suicide lawsuit", "chatbot self-harm lawyer", "AI companion lawsuit"],
    "pfas_contamination":     ["PFAS lawsuit", "forever chemicals lawyer", "PFOA lawsuit attorney", "PFOS contamination lawsuit", "firefighter PFAS exposure"],
    "cpap":                   ["philips cpap lawsuit", "philips respironics recall lawyer", "cpap cancer lawsuit", "dreamstation recall lawsuit"],
    "3m_earplugs":            ["3m earplugs lawsuit", "3m combat arms lawsuit", "3m military earplug settlement", "3m earplug hearing loss lawyer"],
}
