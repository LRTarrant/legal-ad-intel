  ...
  return (
    <div className="space-y-8 animate-pulse">
      <div className="flex items-center gap-3">
        <div className="h-7 w-7 rounded bg-cloud" />
        <div>
          <div className="h-7 w-72 rounded bg-cloud" />
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <div className="h-[340px] rounded-xl bg-cloud" />
        <div className="h-[340px] rounded-xl bg-cloud" />
      </div>
      <div className="h-[380px] rounded-xl bg-cloud" />
