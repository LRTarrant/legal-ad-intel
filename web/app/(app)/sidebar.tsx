...
const STATE_PROFILES: NavItem[] = [
  ...
  { label: "California", href: "/state-intelligence/v2/california", Icon: MapPin },
  ...
  { label: "Delaware", href: "/state-intelligence/v2/delaware", Icon: MapPin },
  { label: "District of Columbia", href: "/state-intelligence/v2/district-of-columbia", Icon: MapPin },
  { label: "Florida", href: "/state-intelligence/v2/florida", Icon: MapPin },
  { label: "Georgia", href: "/state-intelligence/v2/georgia", Icon: MapPin },
  ...
  { label: "Montana", href: "/state-intelligence/v2/montana", Icon: MapPin },
  ...
  { label: "North Dakota", href: "/state-intelligence/v2/north-dakota", Icon: MapPin },
  ...
  { label: "Wyoming", href: "/state-intelligence/v2/wyoming", Icon: MapPin },
];
