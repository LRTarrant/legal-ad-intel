    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { label: "Depo-Provera", href: "/advertising/torts/depo_provera", Icon: Syringe },
          { label: "Roundup", href: "/advertising/torts/roundup", Icon: Leaf },
          { label: "Hair Relaxer", href: "/advertising/torts/hair_relaxer", Icon: Scissors },
          { label: "Talcum Powder", href: "/advertising/torts/talcum_powder", Icon: Droplets },
          { label: "Paraquat", href: "/advertising/torts/paraquat", Icon: Tractor },
          { label: "AFFF / Firefighter Foam", href: "/advertising/torts/firefighter_foam", Icon: FlameKindling },
          ...
          { label: "Bard PowerPort", href: "/advertising/torts/bard_powerport", Icon: Activity },
      ...
      },
      {
        ...
        items: [
          ...
          { label: "Olympus Scopes (Pre-MDL)", href: "/advertising/torts/olympus_scopes", Icon: Stethoscope },
          { label: "AI Suicide / Self-Harm (Pre-MDL)", href: "/advertising/torts/ai_suicide", Icon: ShieldAlert },
        ],
      },
    ],
  },
