import { getAdEventCount, getTotalSpend, getRecentAdEvents, getSpendByChannel } from "@/lib/queries/ad-events";
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <SummaryCard label="Total Ad Events" value={adEventCount.toLocaleString()} />
          <SummaryCard label="Total Spend" value={formatCurrency(totalSpend)} />
          <SummaryCard label="Active Firms" value={firmCount.toLocaleString()} />
          <SummaryCard label="Active Markets" value={marketCount.toLocaleString()} />
        </div>
